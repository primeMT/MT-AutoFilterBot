...
# Ask Doubt on telegram @johnwickpetbot
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        if AUTH_CHANNEL and not await is_subscribed(client, query):
            await query.answer("Jᴏɪɴ ᴏᴜʀ Bᴀᴄᴋ-ᴜᴘ ᴄʜᴀɴɴᴇʟ ғɪʀsᴛ! 😒", show_alert=True)
            return
     ...
     #   if not search:
      ...
      #      return
        ...
        try:
            ...
            return
    # don't change anything without contacting me @johnwickpetbot
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴍᴀᴋᴇ ʙᴏᴛ ʟɪᴋᴇ ᴛʜɪs', url="https://t.me/movie4sure")
        ],[
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.ABOUT_TXT.format(temp.U_NAME, temp.B_NAME, GRP_LNK),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.EXTRAMOD_TXT.format(OWNER_LNK),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
        ...
        btn = [[
            InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
            InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="telegram.me/johnwickpetbot")
        ]]
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
